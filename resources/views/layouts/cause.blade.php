            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Faktor Utama Penyebab Stunting</h1>
                    </div>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Kelengkapan
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Faktor Tambahan</h6>
                                </div>
                                <div class="card-body">
                                    ...
                                    kesehatan, pendidikan serta produktifitasnya di kemudian hari. Anak 
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Faktor Lainnya</h6>
                                </div>
                                <div class="card-body">
                                    Faktor lainnya yang menyebabkan stunting adalah terjadi infeksi pada 
                                    ibu, kehamilan remaja, gangguan mental pada ibu, jarak kelahiran anak 
                                    yang pendek, dan hipertensi. Selain itu, rendahnya akses terhadap 
                                    pelayanan kesehatan termasuk akses sanitasi dan air bersih menjadi 
