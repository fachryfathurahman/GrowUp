                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-4 text-center small">
                                            ...
                                            switch($ages[$index]){
                                                ...
                                                break;
                                                case 24: echo "<p>Anda sudah bisa melepas pemberian asi kepada anak anda</p>";
                                                break;
                                            }
                                            ?>
                                        <span class="mr-2">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-4">
                                        ...
                                        <form class="user" action="/add" method="post">
                                            {{ csrf_field() }}
                                                ...
                                                <div class="col-sm-6 mb-3 mb-sm-0">
                                                    ...
                                                    <div class="col-sm-6">
                                                    Umur <input type="number" class="form-control form-control-user" name="age" required="required"> 
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-sm-6 mb-3 mb-sm-0">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 mb-4">
                                    anak anda yang bernama {{$child->name}} sekarang berumur ---
                                </div>
                                @endforeach
                                <div class="col-lg-6 mb-4">
