                        ...
                        <div class="hidden md:flex items-center space-x-1">
                            <div class="dropdown inline-block relative">
                                <button
                                    ...
                                    <img src="{{ URL::asset('storage/'.Auth::user()->profil_picture) }}" class="w-10 rounded-full"
                                        alt="">
            ...
            <div class="mobile-menu hidden md:hidden font-medium">
                ...
                @auth
                    <div class="flex flex-row py-4 px-4">
                        <img src="{{ URL::asset('storage/'.Auth::user()->profil_picture) }}" class="w-8 rounded-full" alt="">
